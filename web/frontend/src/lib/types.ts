...
export type WorkerInbound =
  ...
  | { type: "reset"; start?: { surah: number; ayah: number }; deferCorrections?: boolean; requestId?: number }
  | { type: "set_expected_ayah"; ref: { surah: number; ayah: number } }
...
export type WorkerOutbound =
  | { type: 'recitation_preamble'; kind: 'basmala'; complete: boolean }
  | { type: "stopped"; requestId: number }
  | { type: "reset_done"; requestId: number }
